  ...
  <span>
    ...
    >
      <DeepLynxForm
        ...
        :connected_metatypes="parameter_connected_types"
        ref="form"
      />
    </DeepLynxModal>
  </span>
  ...
  methods: {
    async submit() {
      ...
      await axios.post(
        ...
        store.commit('set_message_text', `Parameter posted with response status ${response.status}`)
